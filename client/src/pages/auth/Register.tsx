...
const registerSchema = z.object({
  ...
  role: z.enum(['admin', 'teacher', 'counselor', 'student']).optional(),
});
      ...
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <div className="mt-1">
            <select
              {...register('role')}
              className="appearance-none block w-full px-4 py-2.5 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent sm:text-sm transition-all bg-gray-50/50"
            >
